...
import { EnhancedPresentationInputSchema } from '@/lib/validation';
...
export const POST = asyncHandler(async (request: NextRequest) => {
    ...
    const validatedInput = EnhancedPresentationInputSchema.parse(body);

    // Generate prompt
    const generatedPrompt = await promptGenerator.generatePresentationPrompt(validatedInput);
