...
import { EnhancedAssessmentInputSchema } from '@/lib/validation';
...
export const POST = asyncHandler(async (request: NextRequest) => {
    ...
    const validatedInput = EnhancedAssessmentInputSchema.parse(body);

    // Generate prompt
    const generatedPrompt = await promptGenerator.generateAssessmentPrompt(validatedInput);
